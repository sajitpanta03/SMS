...
$deletedTeacher = Teacher::selectDeleted('id, name, email, address, phone_number, created_at, deleted_at');
?>
        ...
        <div class="card my-4">
          <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            <div class="row bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Teacher Recycle Bin</h6>
            </div>
          </div>
            ...
            <div class="table-responsive p-0">
              <table class="table align-items-center mb-0">
                ...
                <tbody>
                  ...
                  <?php
                  foreach ($deletedTeacher as $teacher) {
                  ?>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center">
                        <div class="d-flex flex-column justify-content-center">
                          ...
                          <span class="text-secondary text-xs font-weight-bold"><?php echo $teacher['deleted_at']; ?> Deleted</span>
                        </div>

                      </td>
                      <td class="align-middle">
                        <a href="http://localhost/php/OOP/student-management-system/teacherController/restoreTeacher.php?id=<?php echo $teacher['id']; ?>" style="color: #000000;">
